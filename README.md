...
오버레이는 위쪽에 이전 자막 1개를 작고 옅게, 아래쪽에 현재 번역을 선명하게 표시합니다. 같은 자막의 중간 번역은 아래쪽에서만 갱신되며, 새 자막으로 넘어갈 때 직전 번역을 위쪽에 남깁니다. 기본 창 크기는 `980×240`이며, 긴 문장은 글자 크기를 줄여 표시합니다. 매우 긴 문장은 끝부분이 생략될 수 있습니다. 번역 요청 주기와 모델 설정은 바뀌지 않습니다.
